...
$page_title = 'View Enrollment Details';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="min-h-screen">
        ...
        <header class="bg-blue-600 text-white p-4 shadow-md">
            <div class="container mx-auto flex items-center justify-between">
                ...
                <a href="enrollment.php" class="text-white hover:text-blue-200">
                    <i class="fas fa-arrow-left mr-2"></i> Back to Enrollment Management
                </a>
            </div>
        </header>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                    <h3 class="text-lg font-bold text-gray-800 mb-4 border-b pb-2">
                        <i class="fas fa-clipboard-list mr-2 text-blue-600"></i> Enrollment Information
                    </h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-900"><?php echo $student['created_at'] ? date('F j, Y', strtotime($student['created_at'])) : 'N/A'; ?></p>
                        </div>
                        <div>
                ...
                <div class="flex justify-between items-center">
                    <a href="enrollment.php" class="text-gray-600 hover:text-gray-800">
                        <i class="fas fa-arrow-left mr-2"></i> Back to Enrollment Management
                    </a>
                    <div class="space-x-3">
                        <?php if ($student['status'] === 'Pending'): ?>
                        <button onclick="approveEnrollment(<?php echo $student['id']; ?>)" class="bg-green-600 text-white px-6 py-2 rounded-lg hover:bg-green-700">
                            <i class="fas fa-check mr-2"></i> Approve Enrollment
                        </button>
                        <button onclick="rejectEnrollment(<?php echo $student['id']; ?>)" class="bg-red-600 text-white px-6 py-2 rounded-lg hover:bg-red-700">
                            <i class="fas fa-times mr-2"></i> Reject Enrollment
                        </button>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    <script>
        function approveEnrollment(studentId) {
            if (confirm('Are you sure you want to approve this enrollment?')) {
                window.location.href = 'approve_enrollment.php?id=' + studentId;
            }
        }

        function rejectEnrollment(studentId) {
            if (confirm('Are you sure you want to reject this enrollment?')) {
                window.location.href = 'reject_enrollment.php?id=' + studentId;
            }
        }
    </script>
</body>
